<#
.SYNOPSIS
    KERNEL IA - QA E2E Test Suite: Gemma 3 (Docker Model Runner)
.DESCRIPTION
    Ejecuta pruebas automatizadas contra el endpoint de Gemma 3
.USAGE
...
Write-Host ""
Write-Header "REPORTE QA E2E - GEMMA 3 (Docker Model Runner)"
Write-Host ""
...
$reportPath = Join-Path $reportDir "qa_gemma3_results.json"
$report = @{
