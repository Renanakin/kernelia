...
pub const CHECKPOINTS_SQL: &str = include_str!("../../../migrations/0003_kernelia_hitl_checkpoints.sql");
...
pub const FAQS_WIN_SEED_SQL: &str =
...
pub fn all_seeds() -> [(&'static str, &'static str); 6] {
    [
