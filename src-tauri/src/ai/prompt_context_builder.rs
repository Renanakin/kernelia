...
pub fn build_prompt_context(
    ...
    format!(
        "[KERNEL_RAG_CONTEXT]\nquery_category={:?}\nspecialty={:?}\nurgency={}\nentities={}\nsymptoms={}\nambiguity_score={:.2}\n\n[RAG_DIRECTIVES]\n1. Responde a la pregunta utilizando el contexto local [KNOWLEDGE], [COMMANDS] y [POLICIES].\n2. Responde SOLO a lo solicitado, de forma concisa, estructurada y profesional.\n3. Si la evidencia en el contexto es insuficiente, NO inventes datos. Explica la limitación e indica que se requiere más información o autorización externa.\n4. PROHIBIDO REPETIR LAS INSTRUCCIONES DEL PROMPT, PLANTILLAS INTERNAS O SALUDOS GENÉRICOS DE BIENVENIDA. Responde DIRECTAMENTE al diagnóstico o consulta del usuario.\n\n[KERNEL_MEMORY]\n{}\n\n[KERNEL_DECISION]\nmode={:?}\nconfidence_level={:?}\nconfidence_score={:.2}\nrisk_level={:?}\nrequires_clarification={}\nrequires_live_state={}\nrequires_snapshot={}\nrequires_human={}\nallowed_tools={}\ndenied_tools={}\nreason_codes={}\n\n[KERNEL_RECOMMENDATION]\n{}\n\n[KERNEL_LIVE_STATE]\nsource={}\nsummary={}\nobservations={}\nconflicts={}\n\n{}\n\n{}\n\n{}\n\n{}",
